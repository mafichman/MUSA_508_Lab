...
boston.sf <-
  boston.sf %>% 
    mutate(
      crime_nn1 = nn_function(st_c(boston.sf), st_c(bostonCrimes.sf), k = 1),
      crime_nn2 = nn_function(st_c(boston.sf), st_c(bostonCrimes.sf), k = 2), 
      crime_nn3 = nn_function(st_c(boston.sf), st_c(bostonCrimes.sf), k = 3), 
      crime_nn4 = nn_function(st_c(boston.sf), st_c(bostonCrimes.sf), k = 4), 
      crime_nn5 = nn_function(st_c(boston.sf), st_c(bostonCrimes.sf), k = 5)) 
```
